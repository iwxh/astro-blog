...
AstroPaper v2 has a new dark color scheme (high contrast & low contrast) which is based on Astro's dark logo. Check out [this link](https://taram.cn/posts/predefined-color-schemes#astro-dark) for more info.
...
All the [#docs](https://taram.cn/tags/docs/) blog posts and [README](https://github.com/satnaing/astro-paper#readme) are updated for this AstroPaper v2.
